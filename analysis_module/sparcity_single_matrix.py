# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 11:55:49 2024
...
# Define paths
data_file_path = r'D:\epan\EP\BNT\from_finalmodels\results\\correlation\\matrix\\gat_all_sub3.txt'
#OUTPUT_FOLDER_PATH = r'D:\\epan\\BNT\\from_finalmodels\\results\\correlation\\percent99\\'
'''
...
np.savetxt(f'D:\\epan\\BNT\\from_finalmodels\\results\\correlation\\percent99\\binary_adj_matrix_0.txt', binary_adj_matrix, fmt='%d', delimiter=' ')
